...
public class SimOutletUI extends AbstractOutletUI {

	private static final Logger LOG = Logger.getLogger(SimOutletUI.class.getName());
	 ...
	 *            cannot be {@code null}
	 */
	public SimOutletUI(final OutletImpl model) {
		super(model);
	...
	@Override
	protected void updateFromModel(Outlet model) {
