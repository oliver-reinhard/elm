...
import elm.hs.api.model.HomeServerObject;
...
public abstract class AbstractHomeServerClient {
	 ...
	 */
	protected <T extends HomeServerObject> T doGet(String resourcePath, Class<T> resultClass) throws ClientException {
	 ...
	 * @return {@code null} if not-OK return status or an exception
	 */
	protected <T extends HomeServerObject> T doGet(String resourcePath, Class<T> resultClass, int[] httpSuccessStatuses) throws ClientException {
