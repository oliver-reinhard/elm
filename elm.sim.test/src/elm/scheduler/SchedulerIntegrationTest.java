...
public class SchedulerIntegrationTest {
	...
	public void scheduling_IgnoreDeviceStates() {
		try {
			...
			// ON --> ON
			hs1_Devices = createDevicesWithStatus(1, NUM_DEVICES, 0);
			...
			hs2_Devices = createDevicesWithStatus(2, NUM_DEVICES, 0);
			...
			hs3_Devices = createDevicesWithStatus(3, NUM_DEVICES, 0);
			...
			checkNoUserFeedback(hs2, d2_2); // tap ON, feedback has not changed from previous update "ON, 0 ms"
			checkUserFeedback(hs3, d3_1, SATURATION, 0);
			checkUserFeedback(hs3, d3_2, ON, 0); // has a shorter wait time since it is TRYING TO CONSUME
			...
			checkNoUserFeedback(hs2, d2_2); // tap ON, feedback has not changed from previous update "ON, 0 ms"
			checkUserFeedback(hs3, d3_1, ON, 0);
			checkNoUserFeedback(hs3, d3_2); // tap ON, feedback has not changed from previous update "ON, 0 ms"
			//
