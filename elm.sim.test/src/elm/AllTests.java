...
import elm.scheduler.model.impl.DeviceManagerTest;
import elm.scheduler.model.impl.HomeServerTest;
import elm.sim.model.TapPointTest;

@RunWith(Suite.class)
@SuiteClasses({DeviceManagerTest.class, HomeServerTest.class, AbstractSchedulerTest.class, SchedulerTest.class, TapPointTest.class, DeviceTapPointAdapterTest.class})
